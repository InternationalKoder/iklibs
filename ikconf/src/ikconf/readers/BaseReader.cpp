...
template<>
bool ikconf::BaseReader::tryConvertAndSetProperty<bool>(const std::string& name, const std::any& value)
{
...
template<>
bool ikconf::BaseReader::tryConvertAndSetProperty<std::string>(const std::string& name, const std::any& value)
{
    const std::any propertyValue = m_configuration.getPropertyValue(name);
